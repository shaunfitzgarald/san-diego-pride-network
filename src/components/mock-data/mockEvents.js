...
const mockEvents = [
  {
    ...
    price: 'Free',
    tags: ['parade', 'pride', 'equality', 'celebration', 'marching', 'walking', 'floats', 'drag', 'fun', 'family', 'music', 'dancing', 'performances'],
  ...
  },
    {
      ...
      tags: ['concert', 'charity', 'music', 'performances', 'donation', 'charities'],
    ...
    },
    {
      ...
      price: 'Free',
      tags: ['movie', 'outdoor', 'family', 'night', 'cinema', 'film', 'entertainment'],
    ...
    },
    {
      ...
      tags: ['food', 'festival', 'cuisine', 'family', 'dinner', 'lunch', 'eats', 'dishes', 'drinks'],
    ...
    },
    {
      ...
      tags: ['technology', 'conference', 'workshops', 'networking', 'business', 'entrepreneurship', 'markeing', 'startup'],
    ...
    },
    {
      ...
      tags: ['sports', 'marathon', 'running', 'fitness', 'walking', 'jogging', 'race'],
    ...
    },
    {
      ...
      tags: ['books', 'literature', 'fair', 'authors', 'reading', 'drag', 'storytime', 'kids'],
    ...
    },
    {
      ...
      tags: ['film', 'festival', 'cinema', 'international', 'movies', 'entertainment', 'sundance'],
    ...
    },
    {
      ...
      price: 'Free',
      tags: ['art', 'crafts', 'festival', 'workshops', 'family', 'kids', 'DIY', 'fun', 'arts and crafts'],
